...
struct TransitAnalysis {
  ...
  TransitContext context;                   ///< 本次大运、流年、流月排布。
...
struct AnalysisResult {
  std::string schema_version{"1.7"}; ///< JSON 和中文命理报告的格式版本。
  ...
  BirthContext birth_context;                 ///< 出生时刻、节令与分日司令。
  std::array<Pillar, 4> input_pillars;        ///< 原局年、月、日、时四柱。
