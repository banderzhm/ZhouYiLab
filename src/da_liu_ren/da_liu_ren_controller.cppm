...
public:
   ...
   */
  static DaLiuRenResult pai_pan_solar(
   ...
   * @param day_zhi 日支
   */
  static void display_tian_di_pan(const TianDiPan &tian_di_pan, TianGan day_gan,
                                  DiZhi day_zhi);
   ...
   * @param san_chuan 三传
   */
  static void display_san_chuan(const SanChuan &san_chuan, TianGan day_gan,
                                DiZhi day_zhi);
...
private:
   ...
   */
  static void get_date_input(int &year, int &month, int &day, int &hour,
                             bool &is_lunar);
