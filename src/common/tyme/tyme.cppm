...
using namespace std;
using namespace tyme::ephemeris;
/**
 * @brief 节日类型
 */
enum class FestivalType { DAY = 0, TERM = 1, EVE = 2 };
 ...
 * @brief 藏干类型
 */
enum class HideHeavenStemType { RESIDUAL = 0, MIDDLE = 1, MAIN = 2 };

/**
 * @brief 内外
 */
enum class Side { IN = 0, OUT = 1 };

/**
 * @brief 阴阳
 */
enum class YinYang { YIN = 0, YANG = 1 };
...
public:
   ...
   */
  LoopTyme(const vector<string> &names, const int index)
      : names(names), index(index_of(index)) {}
   ...
   * @param name 名称
   */
  LoopTyme(const vector<string> &names, const string &name)
      : names(names), index(index_of(name)) {}
...
public:
  ...
  explicit DogDay(const Dog &dog, const int day_index)
      : dog(dog), day_index(day_index) {}
...
public:
  ...
  explicit NineDay(const Nine &nine, const int day_index)
      : nine(nine), day_index(day_index) {}
...
public:
  ...
  explicit PlumRainDay(const PlumRain &plum_rain, const int day_index)
      : plum_rain(plum_rain), day_index(day_index) {}
...
public:
  ...
  explicit HideHeavenStem(const HeavenStem &heaven_stem,
                          const HideHeavenStemType type)
      : heaven_stem(heaven_stem), type(type) {}

  explicit HideHeavenStem(const string &heaven_stem_name,
                          const HideHeavenStemType type)
      : heaven_stem(HeavenStem::from_name(heaven_stem_name)), type(type) {}

  explicit HideHeavenStem(const int heaven_stem_index,
                          const HideHeavenStemType type)
...
public:
  ...
  explicit HideHeavenStemDay(const HideHeavenStem &hide_heaven_stem,
                             const int day_index)
...
public:
  ...
  static vector<God> get_day_gods(const SixtyCycle &month,
                                  const SixtyCycle &day);
...
public:
   ...
   * @return 宜忌列表
   */
  static vector<Taboo> get_day_recommends(const SixtyCycle &month,
                                          const SixtyCycle &day);
   ...
   * @return 宜忌列表
   */
  static vector<Taboo> get_day_avoids(const SixtyCycle &month,
                                      const SixtyCycle &day);
   ...
   * @return 宜忌列表
   */
  static vector<Taboo> get_hour_recommends(const SixtyCycle &day,
                                           const SixtyCycle &hour);
   ...
   * @return 宜忌列表
   */
  static vector<Taboo> get_hour_avoids(const SixtyCycle &day,
                                       const SixtyCycle &hour);
...
private:
  static vector<Taboo> get_taboos(vector<string> data, int sup_index,
                                  int sub_index, int index);
};
...
public:
  ...
  explicit SixtyCycleYear(const int year) : AbstractCulture() {
    if (year < -1 || year > 9999) {
      throw invalid_argument("illegal sixty cycle year: " +
                             std::to_string(year));
    }
    this->year = year;
  }
...
public:
  ...
  explicit JulianDay(const double day) : AbstractCulture() { this->day = day; }

  static JulianDay from_julian_day(double day);

  static JulianDay from_ymd_hms(int year, int month, int day, int hour,
...
public:
  ...
  explicit LunarYear(const int year) : AbstractCulture() {
    ...
    call_once(flag, [] {
      ...
      string months[] = {
          "080b0r0j0j0j0C0j0j0C0j0j0j0C0j0C0j0C0F0j0V0V0V0u0j0j0C0j0j0j0j0V0C0j"
          "1v0u0C0V1v0C0b080u110u0C0j0C1v9K1v2z0j1vmZbl1veN3s1v0V0C2S1v0V0C2S2o"
          "0C0j1Z1c2S1v0j1c0j2z1v0j1c0j392H0b2_"
          "2S0C0V0j1c0j2z0C0C0j0j1c0j0N250j0C0j0b081n080b0C0C0C1c0j0N",
          "0b0j0C0j0j0j0u110u0j0j0j0j0j0j0j0j0C0C0j0b0j0j0j0C0j0C0C0j0b080b080b"
          "0j0C0j080b0j0C0j0j0j0b0j110b0j0j0j0j0j",
          "0B0j0V0j0j0C0j0j0j0C0j0C0j0j0C0j0m0j0j0j0j0C0j0C0j0j0u0j1c0j0j0C0C0j"
          "0j0j0j0j0j0j0j0u110N0j0j0V0C0V0j0b081n080b0CrU1O5e2SbX2_"
          "1Z0V2o141v0j0C0C0j2z1v0j1c0j7N1O420j1c0j1v2S1c0j1v2S2_"
          "0b0j0V0j0j1v0N1v0j0j1c0j1v140j0V0j0j0C0C0b080u1v0C0V0u110u0j0j0j0C0j"
          "0j0j0C0C0N0C0V0j0j0C0j0j0b080u110u0C0j0C0u0r0C0u080b0j0j0C0j0j0j"};
  ...
  LunarYear(const LunarYear &other) { year = other.year; }
...
public:
  ...
  explicit SolarTerm(const int year, const string &name)
      : LoopTyme(NAMES, name) {
...
public:
  ...
  LunarMonth(const LunarMonth &other)
      : year(other.year), month(other.month), leap(other.leap),
        day_count(other.day_count), index_in_year(other.index_in_year),
  ...
  explicit LunarMonth(const int year, const int month)
      : AbstractCulture(), year(LunarYear::from_year(year)),
        first_julian_day(0) {
    ...
    if (leap && m != current_leap_month) {
      throw invalid_argument("illegal leap month " + std::to_string(m) +
                             " in lunar year" + std::to_string(year));
    }

    // 冬至
    const double dong_zhi_jd =
        SolarTerm::from_index(year, 0).get_cursory_julian_day();
    ...
    if (year > 8 && year < 24) {
      offset = 1;
    } else if (LunarYear::from_year(year - 1).get_leap_month() > 10 &&
               year != 239 && year != 240) {
      offset = 3;
    }
    ...
    this->first_julian_day =
        JulianDay::from_julian_day(JulianDay::J2000 + first_day);
    // 本月天数 = 下月初一 - 本月初一
    this->day_count =
        static_cast<int>(ShouXingUtil::calc_shuo(w + 29.5306) - first_day);
    this->month = m;
    this->leap = leap;
  }
...
public:
  ...
  explicit LunarWeek(const int year, const int month, const int index,
                     const int start)
      : AbstractCulture(), month(LunarMonth::from_ym(year, month)),
        start(Week::from_index(start)) {
    if (index < 0 || index > 5) {
      throw invalid_argument("illegal lunar week index: " +
                             std::to_string(index));
    }
    if (start < 0 || start > 6) {
      throw invalid_argument("illegal lunar week start: " +
                             std::to_string(start));
    }
    if (index >= this->month.get_week_count(start)) {
      throw invalid_argument(
          "illegal lunar week index: " + std::to_string(index) +
...
public:
  ...
  explicit LunarDay(const int year, const int month, const int day)
    ...
    if (day < 1 || day > this->month.get_day_count()) {
      throw invalid_argument("illegal day " + std::to_string(day) + " in " +
...
public:
  ...
  explicit LunarHour(const int year, const int month, const int day,
  ...
  static LunarHour from_ymd_hms(int year, int month, int day, int hour,
                                int minute, int second);
...
public:
  ...
  explicit SolarHalfYear(const int year, const int index)
      : AbstractCulture(), year(SolarYear::from_year(year)) {
    if (index < 0 || index > 1) {
      throw invalid_argument("illegal solar half year index: " +
                             std::to_string(index));
    }
    this->index = index;
  }
...
public:
  ...
  explicit SolarSeason(const int year, const int index)
      : AbstractCulture(), year(SolarYear::from_year(year)) {
    if (index < 0 || index > 3) {
      throw invalid_argument("illegal solar season index: " +
                             std::to_string(index));
    }
    this->index = index;
  }
...
public:
  ...
  explicit SolarMonth(const int year, const int month)
      : AbstractCulture(), year(SolarYear::from_year(year)) {
    if (month < 1 || month > 12) {
...
public:
  ...
  explicit SolarDay(const int year, const int month, const int day)
    ...
    if (day < 1) {
      throw invalid_argument("illegal solar day: " + std::to_string(year) +
                             "-" + std::to_string(month) + "-" +
                             std::to_string(day));
    }
...
public:
  ...
  explicit SolarWeek(const int year, const int month, const int index,
                     const int start)
      : AbstractCulture(), month(SolarMonth::from_ym(year, month)),
        start(Week::from_index(start)) {
    if (index < 0 || index > 5) {
      throw invalid_argument("illegal solar week index: " +
                             std::to_string(index));
    }
    if (start < 0 || start > 6) {
      throw invalid_argument("illegal solar week start: " +
                             std::to_string(start));
    }
    if (index >= this->month.get_week_count(start)) {
      throw invalid_argument(
          "illegal solar week index: " + std::to_string(index) +
          " in month: " + this->month.to_string());
    }
    this->index = index;
  }
...
public:
  ...
  SolarTime(const SolarTime &other)
      : day(other.day), hour(other.hour), minute(other.minute),
        second(other.second) {}

  SolarTime &operator=(const SolarTime &other);

  explicit SolarTime(const int year, const int month, const int day,
                     const int hour, const int minute, const int second)
  ...
  static SolarTime from_ymd_hms(int year, int month, int day, int hour,
                                int minute, int second);
...
public:
  ...
  explicit EightChar(const SixtyCycle &year, const SixtyCycle &month,
                     const SixtyCycle &day, const SixtyCycle &hour)
      : AbstractCulture(), year(year), month(month), day(day), hour(hour) {}

  explicit EightChar(const string &year, const string &month, const string &day,
                     const string &hour)
      : AbstractCulture(), year(SixtyCycle(year)), month(SixtyCycle(month)),
        day(SixtyCycle(day)), hour(SixtyCycle(hour)) {}
...
public:
  ...
  explicit KitchenGodSteed(const int lunar_year)
      : AbstractCulture(),
        first_day_sixty_cycle(
            LunarDay::from_ymd(lunar_year, 1, 1).get_sixty_cycle()) {}
...
public:
  ...
  explicit PengZu(const SixtyCycle &sixty_cycle)
      : peng_zu_heaven_stem(PengZuHeavenStem::from_index(
            sixty_cycle.get_heaven_stem().get_index())),
        peng_zu_earth_branch(PengZuEarthBranch::from_index(
            sixty_cycle.get_earth_branch().get_index())) {}
...
public:
  ...
  SixtyCycleDay(const SixtyCycleDay &other)
      : solar_day(other.solar_day), month(other.month), day(other.day) {}

  SixtyCycleDay &operator=(const SixtyCycleDay &other);

  explicit SixtyCycleDay(const SolarDay &solar_day,
                         const SixtyCycleMonth &month, const SixtyCycle &day)
      : AbstractCulture(), solar_day(solar_day), month(month), day(day) {}

  explicit SixtyCycleDay(const SolarDay &solar_day)
      : AbstractCulture(), solar_day(solar_day) {
    const int solar_year = solar_day.get_year();
    const SolarDay spring_solar_day =
        SolarTerm::from_index(solar_year, 3).get_julian_day().get_solar_day();
    ...
    if (index < 0 &&
        term.get_julian_day().get_solar_day().is_after(spring_solar_day)) {
      index += 24;
    }
    this->month = SixtyCycleMonth(
        SixtyCycleYear::from_year(lunar_year.get_year()),
        LunarMonth::from_ym(solar_year, 1)
            .get_sixty_cycle()
            .next(static_cast<int>(std::floor(index * 1.0 / 2))));
...
public:
  ...
  explicit SixtyCycleHour(const SolarTime &solar_time)
      : AbstractCulture(), solar_time(solar_time) {
    const int solar_year = solar_time.get_year();
    const SolarTime spring_solar_time =
    ...
    day = SixtyCycleDay(
        ...
        SixtyCycleMonth(SixtyCycleYear::from_year(lunar_year.get_year()),
                        LunarMonth::from_ym(solar_year, 1)
                            .get_sixty_cycle()
                            .next(static_cast<int>(std::floor(index * 0.5)))),
        d);
...
public:
  ...
  explicit FetusDay(const SixtyCycle &sixty_cycle)
      : AbstractCulture(), fetus_heaven_stem(FetusHeavenStem(
                               sixty_cycle.get_heaven_stem().get_index() % 5)),
        fetus_earth_branch(
            FetusEarthBranch(sixty_cycle.get_earth_branch().get_index() % 6)) {
    constexpr int indices[] = {3,  3,  8,  8,  8,  8,  8,  1,  1,  1,  1,  1,
                               1,  6,  6,  6,  6,  6,  5,  5,  5,  5,  5,  5,
                               0,  0,  0,  0,  0,  -9, -9, -9, -9, -9, -5, -5,
                               -1, -1, -1, -3, -7, -7, -7, -7, -5, 7,  7,  7,
                               7,  7,  7,  2,  2,  2,  2,  2,  3,  3,  3,  3};
  ...
  explicit FetusDay(const SixtyCycleDay &sixty_cycle_day)
      : FetusDay(sixty_cycle_day.get_sixty_cycle()) {}

  explicit FetusDay(const LunarDay &lunar_day)
      : FetusDay(lunar_day.get_sixty_cycle()) {}
...
public:
  ...
  explicit Phenology(const int year, const string &name)
      : LoopTyme(NAMES, name) {
    const int size = get_size();
...
public:
  ...
  explicit PhenologyDay(const Phenology &phenology, const int day_index)
      : phenology(phenology), day_index(day_index) {}
...
public:
  ...
  explicit ChildLimitInfo(const SolarTime &start_time,
                          const SolarTime &end_time, const int year_count,
                          const int month_count, const int day_count,
                          const int hour_count, const int minute_count)
      : start_time(start_time), end_time(end_time), year_count(year_count),
        month_count(month_count), day_count(day_count), hour_count(hour_count),
...
public:
   ...
   * @return 童限信息
   */
  virtual ChildLimitInfo get_info(SolarTime birth_time,
                                  SolarTerm term) const = 0;
};
...
public:
  ChildLimitInfo next(const SolarTime &birth_time, int add_year, int add_month,
                      int add_day, int add_hour, int add_minute,
                      int add_second) const;
};
...
public:
  ...
  explicit ChildLimit(const SolarTime &birth_time, const Gender gender)
      : eight_char(birth_time.get_lunar_hour().get_eight_char()),
        gender(gender), forward(get_forward(eight_char, gender)),
...
public:
  ...
  explicit Fortune(const ChildLimit &child_limit, const int index)
      : child_limit(child_limit), index(index) {}
...
public:
  ...
  explicit DecadeFortune(const ChildLimit &child_limit, int index)
      : child_limit(child_limit), index(index) {}

  static DecadeFortune from_child_limit(const ChildLimit &child_limit,
                                        int index);
...
public:
  ...
  explicit LegalHoliday(const int year, const int month, const int day,
                        const string &data)
      : day(SolarDay::from_ymd(year, month, day)), name(NAMES[data[9] - '0']),
        work(data[8] == '0'), target(compute_target(data)) {}
...
public:
  ...
  explicit RabByungElement(const string &name)
      : Element(regex_replace(name, regex("铁"), "金")) {}
...
public:
  ...
  explicit RabByungYear(const int rab_byung_index,
                        const SixtyCycle &sixty_cycle)
      : AbstractCulture(), rab_byung_index(rab_byung_index),
        sixty_cycle(sixty_cycle) {
    if (rab_byung_index < 0 || rab_byung_index > 150) {
      throw invalid_argument("illegal rab-byung index: " +
                             std::to_string(rab_byung_index));
    }
  }

  static RabByungYear from_sixty_cycle(int rab_byung_index,
                                       const SixtyCycle &sixty_cycle);

  static RabByungYear from_element_zodiac(int rab_byung_index,
                                          const RabByungElement &element,
                                          const Zodiac &zodiac);
...
public:
  ...
  explicit RabByungMonth(const RabByungYear &year, const int month)
    ...
    if (month == 0 || month > 12 || month < -12) {
      throw invalid_argument("illegal rab-byung month: " +
                             std::to_string(month));
    }
    const int y = year.get_year();
    if (y < 1950 || y > 2050) {
      throw invalid_argument("rab-byung year " + std::to_string(month) +
                             " must between 1950 and 2050");
    }
    const int m = abs(month);
    if (y == 1950 && m < 12) {
      throw invalid_argument("month " + std::to_string(month) +
                             " must be 12 in rab-byung year " +
                             std::to_string(y));
    }
    const int leap_month = year.get_leap_month();
    if (leap && m != leap_month) {
      throw invalid_argument("illegal leap month " + std::to_string(m) +
                             " in rab-byung year " + std::to_string(y));
    }
    // 位于当年的索引
    int index = m - 1;
  ...
  explicit RabByungMonth(const int year, const int month)
      : RabByungMonth(RabByungYear::from_year(year), month) {}

  explicit RabByungMonth(const int rab_byung_index,
                         const RabByungElement &element, const Zodiac &zodiac,
                         const int month)
      : RabByungMonth(
  ...
  static RabByungMonth from_element_zodiac(int rab_byung_index,
                                           const RabByungElement &element,
                                           const Zodiac &zodiac, int month);
...
public:
  ...
  explicit SolarFestival(const FestivalType type, const SolarDay &day,
                         const int start_year, const string &data)
      : _type(type), index(stoi(data.substr(1, 2))), day(day),
        name(NAMES[index]), start_year(start_year) {}
...
public:
  ...
  explicit LunarFestival(const FestivalType type, const LunarDay &day,
                         optional<SolarTerm> solar_term, const string &data)
      : _type(type), index(stoi(data.substr(1, 2))), day(day),
        name(NAMES[index]), solar_term(std::move(solar_term)) {}
...
public:
  ...
  explicit RabByungDay(const RabByungMonth &month, const int day)
    ...
    const int d = abs(day);
    if (leap) {
      if (vector<int> l = month.get_leap_days();
          find(l.begin(), l.end(), d) != l.end()) {
        throw invalid_argument("illegal leap day " + std::to_string(d) +
                               " in " + month.to_string());
      }
    }
    if (!leap) {
      if (vector<int> l = month.get_miss_days();
          find(l.begin(), l.end(), d) != l.end()) {
        throw invalid_argument("illegal day " + std::to_string(d) + " in " +
                               month.to_string());
      }
    }
  }

  explicit RabByungDay(const int year, const int month, const int day)
      : RabByungDay(RabByungMonth(year, month), day) {}

  explicit RabByungDay(const int rab_byung_index,
                       const RabByungElement &element, const Zodiac &zodiac,
                       const int month, const int day)
      : RabByungDay(RabByungMonth(rab_byung_index, element, zodiac, month),
                    day) {}

  static RabByungDay from_ymd(int year, int month, int day);

  static RabByungDay from_element_zodiac(int rab_byung_index,
                                         const RabByungElement &element,
                                         const Zodiac &zodiac, int month,
                                         int day);
...
public:
  ...
  explicit Phase(const int lunar_year, const int lunar_month, const int index)
      : LoopTyme(NAMES, index) {
    const LunarMonth m = LunarMonth::from_ym(lunar_year, lunar_month)
                             .next(index / static_cast<int>(NAMES.size()));
    this->lunar_year = m.get_year();
    this->lunar_month = m.get_month_with_leap();
  }

  explicit Phase(const int lunar_year, const int lunar_month,
                 const string &name)
      : LoopTyme(NAMES, name), lunar_year(lunar_year),
...
public:
  ...
  explicit PhaseDay(const Phase &phase, const int day_index)
      : phase(phase), day_index(day_index) {}
