...
struct StarData {
  string name;                // 星耀名称
  optional<LiangDu> liang_du; // 亮度；该流派未定义时为空
 ...
 */
pair<int, int>
get_kui_yue_index(TianGan year_gan,
                  KuiYueSchool school = KuiYueSchool::Traditional);
 ...
 *
 *
 * 此处仅处理“鼠忌羊头上”所起的生年大耗。龙德属于岁前十二神，
 *
 * 应由 arrange_sui_qian_12() 定位，不能误按大耗对宫安置。
 */
