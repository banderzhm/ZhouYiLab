...
// XingYaoWuXing、XingYaoYinYang 由 StarDoc.Types 类型契约统一提供。
...
static const map<string, StarDocument> FU_XING_DATABASE = {
    ...
    {"左辅",
     {.name = "左辅",
      ...
      .bie_hao = "贵人星",
      .description =
          "左辅的特质是助力，喜欢帮助、提拔别人。这种帮助是有点\"长辈视角\"的从"
          "上而下的帮助。"
    ...
    {"天魁",
     {.name = "天魁",
      ...
      .description =
          "天魁星是天乙贵人，散发出领导的气质。有比较强的领导欲望，喜欢\"管人\""
          "，决策上比较果断。"
          "魁钺都比较容易打官腔，深谙咬文嚼字之道。"
          "在贵人星里面，天魁星的助力是需要自己去争取的，并且只会帮你解决眼下的"
          "事情，"
    ...
    {"天钺",
     {.name = "天钺",
      ...
      .description =
          "天钺星叫玉堂贵人，帮助和右弼星一样比较间接。"
          "天魁星善于领导，而天钺星善于策划，善于思考、分析和制定方案。"
          "如果天魁星喜欢\"管人\"，那天钺星就是喜欢\"管事\"，不喜欢别人对他们负"
          "责的事情指手画脚。"
          "和天魁星的脚痛医脚不一样，天钺星更容易直接解决问题的源头，把\"麻烦\""
          "化解于无形。"
    ...
    {"文昌",
     {.name = "文昌",
      ...
      .description =
          "文昌星是紫微斗数第一科甲之星，代表文书类的事务，可以看作是\"小天梁\""
          "，有天梁的清高和倔强。"
    ...
    {"文曲",
     {.name = "文曲",
      ...
      .bie_hao =
          "八卦星、才艺星、偏房星、才华星、艺术星、桃花星、浪漫星、细姨星",
      .description = "文曲星是紫微斗数里第一文艺之星，代表艺术修养与浪漫，被称"
                     "作\"异途功名\"（艺途功名）。"
                     "异途是和正途相对的，当家长听到你的志向时想拿刀追你，那多"
                     "半就是异途功名。"
                     "文曲星通常比较善于变通，内心多愁善感。"
                     "因为会增加一些表达能力，所以引申出了口舌是非的意象。"
                     "文曲星需要增加自己的文化底蕴，让艺术气息有根基，否则容易"
                     "让人感觉在无病呻吟、故作深沉。"
    ...
    {"地空",
     {.name = "地空",
      ...
      .description =
          "古籍中对地空的描述是\"半空折翅\"。地空星其实算是比较\"中性\"的一颗星"
          "，"
          "之所以让人有半空折翅的感觉，是因为这颗星重点在想而不是做。"
          "地空星比较怕麻烦，一旦做事情步骤多、顾虑多，就容易选择逃避，这是被称"
          "为\"中断星\"的由来。"
          "这颗星善于思考，脑子里想法特别多。如果加上天马星，就形成\"天马行空\""
          "，思维不仅活跃，跳跃性还很强。"
          "这些奇思妙想让地空星在艺术创作、文案策划方面有着比较高的天赋。"
          "然而在实际中，想法需要落地，地空星的脑洞常常因为无法落地而产生\"别人"
          "笑我太疯癫，我笑他人看不穿\"的感觉。",
    ...
    {"地劫",
     {.name = "地劫",
      ...
      .bie_hao = "破财星、谣言星",
      .description =
          "对应地空星的\"半空折翅\"，地劫星叫\"浪里行舟\"。区别是地空主要作用在"
          "思想上，地劫作用在物质上。"
          "地劫星对机会比较挑剔，就算面对诱人的机会也会思虑再三。"
          "因为对机会的挑剔，会错过一些不错的时机，给人一种泼天富贵拍在脸上视而"
          "不见的感觉。"
          "君子爱财取之有道，这种不是什么钱都赚的心态让地劫星成了个\"劳碌命\"。"
          "地劫星是风险厌恶型的星曜，对于需要看长期效果的事情是个不小的挑战。"
          "初期投入了，在有风险告警时没能坚持下去，就有了\"给他人做嫁衣\"的感觉"
          "。短平快才是他们最擅长的节奏。",
    ...
    {"火星",
     {.name = "火星",
      ...
      .zhi_wu = "暴躁破坏",
      .bie_hao = "冲动星",
      .description = "火星会让人变得冲动，但这种冲动是思想上的。火星在做决定时"
                     "容易欠缺考虑，比较容易随心而行。"
                     "这种冲动的思想方式使得他们常常充满活力和决心，乐于追求自"
                     "己的目标，不轻易妥协。"
                     "然而这也可能导致他们在做出决定时缺乏充分的考虑，更容易受"
                     "到情绪的影响而做出冲动的选择。"
                     "比起追求长期的成就和坚实的基础，他们更倾向于追求即时的满"
                     "足和快速的结果。"
                     "火星对于情绪的影响巨大，开心时热情似火，愤怒时犹如狂风暴"
                     "雨，情绪起伏较大，喜怒哀乐都会毫不掩饰地表现出来。",
    ...
    {"铃星",
     {.name = "铃星",
      ...
      .zhi_wu = "刚强惊吓",
      .bie_hao = "闷骚星、顽石星",
      .description = "和火星的直接表达不同，铃星不会直接将情绪一股脑的释放出来"
                     "，而是积压在内心慢慢释放。"
                     "铃星通常给人一种内敛、深沉的印象，更倾向于在内心深处思考"
                     "和消化情绪，不轻易将情感展现在外表。"
                     "这种内敛的特点使得他们在处理情绪时更加冷静和克制，不易被"
                     "外界情绪所左右。"
                     "然而有时候过度的内敛也可能导致情绪积压，需要学会适当地表"
                     "达和释放情感。"
                     "铃星比较喜欢精打细算，善于考虑周全，不轻易冲动行事，喜欢"
                     "有条不紊地规划和安排生活。"
                     "虽然这种谨慎使得他们更稳健可靠，但有时也可能因为过于谨慎"
                     "而错失一些机会。",
    ...
    {"擎羊",
     {.name = "擎羊",
      ...
      .bie_hao = "加工星、叛逆星",
      .description =
          "如果说火星是思想上的冲动，擎羊就是行为上的冲动。这颗星是个典型的行动"
          "派。"
          "擎羊星更倾向于通过实际行动来表达自己，而不是空谈或思考。"
          "他们喜欢迅速地采取行动，勇于面对挑战，不畏艰难，善于迅速做出决策并付"
          "诸行动。"
          "三思而后行在擎羊星这里是不存在的，所以需要注意在行动之前多加思考，避"
          "免因冲动而犯下错误。"
          "擎羊星更注重自己的行动和目标，相对不太在意他人的看法或期待。"
          "他们按照自己的方式和节奏生活，不太受外界影响，在一般人眼中显得有些与"
          "众不同，甚至被认为是\"异类\"。",
    ...
    {"陀罗",
     {.name = "陀罗",
      ...
      .bie_hao = "是非星、纠缠星",
      .description =
          "陀罗星通陀螺，就是小时候抽的那个陀螺，是一颗不停旋转的星曜。"
          "这颗星会带给人一种容易纠结的情绪，纠结就会容易拖延。"
          "陀罗星比较容易在做决定时陷入纠结和犹豫之中，难以迅速做出抉择，在行动"
          "上显得犹豫不决。"
          "诚然，三思而后行可以避免很多风险，也能增加事情的成功率。"
          "但陀罗星还是需要学会克服纠结，勇敢面对抉择，以免错失机会或陷入无休止"
          "的循环之中。"
          "陀罗星善于研究，做事循序渐进不骄不躁，适合接触长线任务，比起眼前利益"
          "更在意长足的进步和沉淀。"
    ...
    {"天马",
     {.name = "天马",
      ...
      .description =
          "要说紫微斗数里最坐不住的星曜，那一定非天马莫属，他会增加很多变数和不"
          "确定性。"
          "天马星精力旺盛，充满活力，喜欢追求刺激和变化，难以坐定，喜欢不断地寻"
          "找新的挑战和机遇。"
          "天马星往往充满了冒险精神，喜欢尝试新鲜事物，对于枯燥乏味的生活缺乏耐"
          "心，渴望自由和多样性，不愿受到束缚和限制。"
          "天马星会积极主动去追求自己内心的目标，喜欢自由自在的氛围。"
          "比起在一个目标上死磕下去，天马星更喜欢寻找不同的机遇和可能性，更容易"
          "发现成功的机会。"
    ...
    {"禄存",
     {.name = "禄存",
      ...
      .zhi_wu = "人寿，贵爵",
      .bie_hao = "财星",
      .description = "如果哪颗星在紫微斗数里最受人欢迎，那可能就是禄存星了。因"
                     "为这是颗财星，有谁会对他有抵抗力呢？"
                     "但是禄存的这个财其实是一种类似于\"本钱\"的感觉。禄存星会"
                     "增加稳定性，因为人对于自己的本钱都是比较谨慎的。"
                     "对于财务的支出，禄存星是非常谨慎的，这种谨慎的态度确实可"
                     "以避免很多经济上的损失，但同时也容易错失很多机会。"
