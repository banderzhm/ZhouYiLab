...
export import ZhouYi.YiJing.HexagramCatalog; // 六十四卦公共资料
...
using HexagramInfo = ZhouYi::YiJing::HexagramInfo;

/** 六爻兼容入口；资料实体由公共六十四卦目录唯一持有。 */
inline const auto &hexagramMap = ZhouYi::YiJing::hexagram_catalog();
